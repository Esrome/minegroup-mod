package catwolf57.mgmod.recipes;
...
public class FroyoFreezerRecipes {

	private static final FroyoFreezerRecipes INSTANCE = new FroyoFreezerRecipes();
	private final Table<ItemStack, ItemStack, ItemStack> smeltingList = HashBasedTable.<ItemStack, ItemStack, ItemStack>create();
	private final Map<ItemStack, Float> experienceList = Maps.<ItemStack, Float>newHashMap();
	
	public static FroyoFreezerRecipes getInstance()
	{
		return INSTANCE;
	}
	
	private FroyoFreezerRecipes() 
	{
		addSinteringRecipe(new ItemStack(ModItems.FROYO, 1, 0), new ItemStack(ModItems.FROYO, 1, 0), new ItemStack(ModBlocks.FROYO, 1, 0), 5.0F);
	}
