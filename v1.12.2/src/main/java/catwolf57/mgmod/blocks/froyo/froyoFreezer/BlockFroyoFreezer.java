...
public class BlockFroyoFreezer extends BlockBase implements ITileEntityProvider {

	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public static final PropertyBool FREEZING = PropertyBool.create("freezing");
	
	public BlockFroyoFreezer(String name) {
		super(name, Material.PACKED_ICE, 3.0F, 2);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ModBlocks.FROYO_FREEZER);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(ModBlocks.FROYO_FREEZER);
	}
	
	@Override
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		if (!worldIn.isRemote){
			playerIn.openGui(MinegroupMod.instance, Reference.GUIFREEZER, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
		return true;
	}
	...
	{
		return new TileEntityFroyoFreezer();
	}
