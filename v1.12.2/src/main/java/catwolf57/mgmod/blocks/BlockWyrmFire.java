...
public class BlockWyrmFire extends Block{
	 ...
	 public static final PropertyInteger AGE = PropertyInteger.create("age", 0, 15);
	    ...
	    {
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.PLANKS, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.DOUBLE_WOODEN_SLAB, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.WOODEN_SLAB, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.OAK_FENCE_GATE, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.SPRUCE_FENCE_GATE, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.BIRCH_FENCE_GATE, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.JUNGLE_FENCE_GATE, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.DARK_OAK_FENCE_GATE, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.ACACIA_FENCE_GATE, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.OAK_FENCE, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.SPRUCE_FENCE, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.BIRCH_FENCE, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.JUNGLE_FENCE, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.DARK_OAK_FENCE, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.ACACIA_FENCE, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.OAK_STAIRS, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.BIRCH_STAIRS, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.SPRUCE_STAIRS, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.JUNGLE_STAIRS, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.ACACIA_STAIRS, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.DARK_OAK_STAIRS, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.LOG, 5, 5);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.LOG2, 5, 5);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.LEAVES, 30, 60);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.LEAVES2, 30, 60);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.BOOKSHELF, 30, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.TNT, 15, 100);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.TALLGRASS, 60, 100);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.DOUBLE_PLANT, 60, 100);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.YELLOW_FLOWER, 60, 100);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.RED_FLOWER, 60, 100);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.DEADBUSH, 60, 100);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.WOOL, 30, 60);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.VINE, 15, 100);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.COAL_BLOCK, 5, 5);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.HAY_BLOCK, 60, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(Blocks.CARPET, 60, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(ModBlocks.MINEGROUP_LOGS, 5, 5);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(ModBlocks.MINEGROUP_LEAVES, 30, 60);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(ModBlocks.MINEGROUP_PLANKS, 5, 20);
	        ((BlockWyrmFire) ModBlocks.WYRM_FIRE).setFireInfo(ModBlocks.WYRM_STAIRS, 5, 20);
	        Blocks.FIRE.setFireInfo(ModBlocks.MINEGROUP_LOGS, 5, 5);
	        Blocks.FIRE.setFireInfo(ModBlocks.MINEGROUP_LEAVES, 30, 60);
	        Blocks.FIRE.setFireInfo(ModBlocks.MINEGROUP_PLANKS, 5, 20);
	        Blocks.FIRE.setFireInfo(ModBlocks.WYRM_STAIRS, 5, 20);
	    }
